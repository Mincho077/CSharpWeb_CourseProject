    ...
    public partial class Reseed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UIN = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveIngredientQuantity = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    MedicineFormId = table.Column<int>(type: "int", nullable: false),
                    QuantityInABox = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "PenCef Pharma GmbH,Schiitzenanger 9,37081,Gottingen,Germany", "PenCef Pharma GmbH" },
                    { 2, "Trading Services Limited, Ireland", "GlaxoSmithKline " },
                    { 3, "Austria", "Sandoz GmbH " },
                    { 4, "124 Dvora HaNevi'a St. Tel Aviv 6944020, Israel", "Teva Pharmaceuticals" },
                    { 5, "Germany", "Berlin-Chemie AG" }
                });
